...
let mockData: MockData = {
  ...
  tasks: [
    // TO DO tasks
    {
      ...
      description:
        "Design the basic layout and structure for the new homepage including header, hero section, features, and footer",
      status: "todo",
      category: "DESIGN",
    ...
    },
    {
      ...
      description:
        "Configure React, TypeScript, Tailwind CSS, and testing framework for the new website build",
      status: "todo",
    ...
    },
    {
      ...
      description:
        "Conduct comprehensive interviews with 15 users to understand current pain points and gather feedback on proposed changes",
      status: "todo",
      category: "RESEARCH",
    ...
    // IN PROGRESS tasks
    {
      ...
      description:
        "Set up OAuth integration and user session management. Resolve layout problems on mobile devices",
      status: "in-progress",
      category: "BUG",
...
export const mockApi = {
  ...
  createUser: async (userData: Partial<User>): Promise<ApiResponse<User>> => {
    ...
    const newUser: User = {
      id: Date.now(),
      name: userData.name || "",
      avatar: userData.avatar || "/src/assets/default-avatar.jpg",
      ...userData,
    };
